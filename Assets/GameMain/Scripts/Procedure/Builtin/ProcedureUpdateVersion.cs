...
namespace SpeciesGame
{
    public class ProcedureUpdateVersion : ProcedureBase
    {
        ...
        protected override void OnEnter(ProcedureOwner procedureOwner)
        {
            ...
            GameEntry.Resource.UpdateVersionList(procedureOwner.GetData<Float>("VersionListLength"), procedureOwner.GetData<Float>("VersionListHashCode"), procedureOwner.GetData<Float>("VersionListCompressedLength"), procedureOwner.GetData<Float>("VersionListCompressedHashCode"), m_UpdateVersionListCallbacks);
