...
namespace SpeciesGame
{
    public class ProcedureVerifyResources : ProcedureBase
    {
        ...
        protected override void OnEnter(ProcedureOwner procedureOwner)
        {
            ...
            GameEntry.Event.Sbscribe(ResourceVerifyStartEventArgs.EventId, OnResourceVerifyStart);
            GameEntry.Event.Sbscribe(ResourceVerifySuccessEventArgs.EventId, OnResourceVerifySuccess);
            GameEntry.Event.Sbscribe(ResourceVerifyFailureEventArgs.EventId, OnResourceVerifyFailure);
