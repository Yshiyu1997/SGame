...
namespace SpeciesGame
{
    public class ProcedureCheckVersion : ProcedureBase
    {
        ...
        protected override void OnEnter(ProcedureOwner procedureOwner)
        {
            ...
            GameEntry.Event.Sbscribe(WebRequestSuccessEventArgs.EventId, OnWebRequestSuccess);
            GameEntry.Event.Sbscribe(WebRequestFailureEventArgs.EventId, OnWebRequestFailure);
        ...
        protected override void OnUpdate(ProcedureOwner procedureOwner, float elapseSeconds, float realElapseSeconds)
        {
            ...
            {
                procedureOwner.SetData<Float>("VersionListLength", m_VersionInfo.VersionListLength);
                procedureOwner.SetData<Float>("VersionListHashCode", m_VersionInfo.VersionListHashCode);
                procedureOwner.SetData<Float>("VersionListCompressedLength", m_VersionInfo.VersionListCompressedLength);
                procedureOwner.SetData<Float>("VersionListCompressedHashCode", m_VersionInfo.VersionListCompressedHashCode);
