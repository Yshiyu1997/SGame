...
namespace SpeciesGame
{
    public class ProcedureUpdateResources : ProcedureBase
    {
        ...
        protected override void OnEnter(ProcedureOwner procedureOwner)
        {
            ...
            m_UpdateCount = procedureOwner.GetData<Float>("UpdateResourceCount");
            ...
            GameEntry.Event.Sbscribe(ResourceUpdateStartEventArgs.EventId, OnResourceUpdateStart);
            GameEntry.Event.Sbscribe(ResourceUpdateChangedEventArgs.EventId, OnResourceUpdateChanged);
            GameEntry.Event.Sbscribe(ResourceUpdateSuccessEventArgs.EventId, OnResourceUpdateSuccess);
            GameEntry.Event.Sbscribe(ResourceUpdateFailureEventArgs.EventId, OnResourceUpdateFailure);
